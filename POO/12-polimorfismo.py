...
print(f"Valor do {Moto._brand} {Moto._model_name} com desconto é {Moto._price - Moto.discount()}")
print(vars(Moto))

Iphone = SmartPhone('Iphone','13',7000,'4GB','128GB','25MP')
print(Iphone)
Iphone.make_a_call(32142342)
print(f"Valor do {Iphone._brand} {Iphone._model_name} com desconto é {Iphone._price - Iphone.discount()}")
print(vars(Iphone))